...
class FindAllRestaurantsUseCaseTest {
    ...
    void shouldReturnOwnerNameInOutput() {
        ...
        assertThat(output.content().get(0).ownerName()).isEqualTo("John Doe");
        assertThat(output.content().get(1).ownerName()).isEqualTo("Jane Doe");
    }
    ...
    void shouldReturnPaginatedListWithFilters() {
        ...
        assertThat(output.content().getFirst().name().getValue()).isEqualTo("The Great Burger");
    }
